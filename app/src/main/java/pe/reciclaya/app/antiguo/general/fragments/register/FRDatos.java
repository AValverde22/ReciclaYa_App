...
import pe.reciclaya.app.antiguo.general.activities.TyCActivity;
...
public class FRDatos extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        Inicializaciones.password(ETPassword);
    ...
    private void crearCuenta() {
        ...
        btnCrearCuenta.setOnClickListener(view1 -> {
            ...
            || !Validaciones.password(ETPassword)

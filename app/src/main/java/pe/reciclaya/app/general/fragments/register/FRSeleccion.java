...
import pe.reciclaya.app.general.adapters.RolRA;
...
public class FRSeleccion extends Fragment implements Inicializaciones.IFragmentRegister {
            ...
            apiService.registerUser(body).enqueue(new Callback<>() {
                ...
                public void onResponse(@NonNull Call<Integer> call, @NonNull Response<Integer> response) {
                    ...
                    if(response.isSuccessful() && response.body() != null) {
                        ...
                        Singleton.getUserLogged().postValue(new User(id, fullName, email, rol));
